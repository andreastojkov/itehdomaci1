...
<body>
  <!-- Modal za izmenu - USLUGE pocetna stranica -->
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="d-grid gap-2">
              <a href='./terminiZaUslugu.php' id='sviTermini'><button class="btn btn-warning" style="background-color: #5D7583;" type="button">Svi termini</button></a>
            </div>
          </form>
  ...
  <!-- Modal za dodavanje - USLUGE pocetna stranica -->
